...
public class Level1 implements Screen 
{
    ...
    public Level1(PlantsAndZombies game)
    {
        arr=new int[3];
       // arr[0]=80;
        arr[0]=205;
        ...
        tractors.add(new Tractor(-20, 130));
        tractors.add(new Tractor(-20, 272));
        tractors.add(new Tractor(-20, 400));
        
        zombies1.add(new Zombie1(205,210));
...
//               int rand=new Random().nextInt(2);
               Zombies newZombie;
//               if(rand==0){
                   newZombie=new Zombie1(305, arr[new Random().nextInt(3)]);
                   zombies1.add(newZombie);
//               }
//               else if(rand==1){
//                   newZombie=new Zombie2(305, arr[new Random().nextInt(3)]);
//                   zombies1.add(newZombie);
//               }
       ...
       /*if(Gdx.input.getX() > 0 && Gdx.input.getX() < 88 &&PlantsAndZombies.height - Gdx.input.getY() < 204 && PlantsAndZombies.height - Gdx.input.getY() >150)   
       {
       ...
       if(choosePea)
       {
            if(Gdx.input.getX()> 110 && Gdx.input.getX()<950 && PlantsAndZombies.height - Gdx.input.getY() < 520 && PlantsAndZombies.height - Gdx.input.getY() > 150)
            {
                  if(Gdx.input.isTouched())
                  {
